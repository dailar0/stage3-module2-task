...
@Component
public class ByIdNewsExtractor extends EntityProcessor {

    public ByIdNewsExtractor(ApplicationContext context) {
    ...
    public void process() {
        ...
        try {
            String result = ((String) methodToInvoke.invoke(controller, id));
