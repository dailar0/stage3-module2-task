...
import com.mjc.school.hadler.EntityManipulatorFactory;
...
public class Communicator {
    ...
    private final EntityManipulatorFactory factory;

    public Communicator(EntityManipulatorFactory factory) {
